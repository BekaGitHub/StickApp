 ...
 */
public class ColorBodyFragment extends Fragment {


    public ColorBodyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_color_body, container, false);
        ...
        applyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sender.execute("ColorBody-" + rgbString);
            }
        });
        return view;
    }
